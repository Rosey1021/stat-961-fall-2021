...
We have that the sample correlation between $\bm{x}_{*1}$ and $\bm{x}_{*2}$ is 
\begin{align*}
  \rho_{\bm{x}_{*1} \bm{x}_{*2}} &= \frac{\sum_{i=1}^n (x_{i1} - \overline{x}_1)(x_{i2} - \overline{x}_2)}{\sqrt{(\sum_{i=1}^n (x_{i1} - \overline{x}_1)^2)(\sum_{i=1}^n (x_{i2} - \overline{x}_2)^2)}} \\
  &\approx \frac{\sum_{i=1}^n x_{i1} x_{i2}}{\sqrt{(\sum_{i=1}^n x_{i1}^2) (\sum_{i=1}^n x_{i2}^2)}}
\end{align*}
