...
%==============================================================================
\begin{sol}
Figure~\ref{fig:regression-line} shows the regression line.

\begin{figure}
<<this-is-a-label, message=FALSE, fig.lp = 'fig:', fig.width = 5, fig.height = 4, fig.align = 'center', out.width = '6.5in', fig.pos = 'H'>>=
