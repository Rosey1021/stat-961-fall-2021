...
summary_stats <-
  ...
  mutate(CrimeRate = str_replace(CrimeRate, pattern = ".*:", replacement = ""),
         Metro = str_replace(Metro, pattern = ".*:", replacement = ""),
         HighSchool = str_replace(HighSchool, pattern = ".*:", replacement = ""),
         Poverty = str_replace(Poverty, pattern = ".*:", replacement = ""))
