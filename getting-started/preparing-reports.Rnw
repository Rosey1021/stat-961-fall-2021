...
\begin{figure}[h!]
\centering
\includegraphics[width = 0.3\textwidth]{test_plot_small.png}
\includegraphics[width = 0.3\textwidth]{test_plot_medium.png}
\includegraphics[width = 0.3\textwidth]{test_plot_large.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width = 0.1\textwidth]{test_plot_medium.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width = 0.4\textwidth]{test_plot_medium.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width = 0.8\textwidth]{test_plot_medium.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width = 0.8\textwidth]{cars-unlabeled.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width = 0.8\textwidth]{cars-labeled.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width = 0.5\textwidth]{fig-formulas.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width = \textwidth]{facet-wrap.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width = \textwidth]{cowplot-demo.png}
