...
Homework assignments will be made available on the Github \href{https://github.com/Katsevich-Teaching/stat-961-fall-2021/tree/main/homework/}{webpage}. As an example, see \href{https://github.com/Katsevich-Teaching/stat-961-fall-2021/blob/main/homework/homework-0/homework-0.pdf}{Homework 0}. To complete homework use the following steps:
...
Homework will be in the Rnw format, based on LaTeX and R. If you need to brush up on LaTeX, browse \href{https://www.overleaf.com/learn}{here}. Useful articles on this page are those under the heading "mathematics" as well as the \href{https://www.overleaf.com/learn/latex/Cross_referencing_sections,_equations_and_floats}{article} on cross-referencing.
